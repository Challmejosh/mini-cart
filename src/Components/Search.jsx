...
const Search = () => {
    ...
    return ( 
        <div className="flex items-center mt-2 justify-center gap-x-3">
            <form onSubmit={(e) =>inputSearch(e,input)} className="flex items-center justify-between w-full gap-x-3 ">
                <input name="search" id="search" value={input} onChange={(e)=>setInput(e.target.value)} type="text" placeholder="Search..." className="bg-transparent w-full flex items-center justify-center rounded-[999px] border p-3  focus:outline-none   " />
